  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div className="bg-green-50 rounded-xl p-4 flex items-start space-x-3">
        <div className="bg-[#25D366] rounded-lg p-1.5 shrink-0 mt-0.5">
        ...
        <div>
          <h3 className="font-bold text-gray-900 text-sm mb-1">Delivery via WhatsApp</h3>
          <p className="text-green-600 text-sm font-semibold">Instant delivery guaranteed</p>
        </div>
      </div>
