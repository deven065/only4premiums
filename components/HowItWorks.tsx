...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Receive credentials in 10 min - 1 hour, start using immediately',
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative bg-white p-8 rounded-2xl border border-gray-200 transition-all hover:shadow-xl z-10">
                ...
                {step.badge && (
                  <div className="inline-flex items-center space-x-1.5 mt-4 bg-[#25D366] text-white px-3 py-1.5 rounded-full text-sm font-medium">
