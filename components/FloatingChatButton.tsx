  ...
  return (
    <>
      ...
      <div className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-60">
        {/* Chat Options Menu */}
        {isOpen && (
          <div className="absolute bottom-20 right-0 bg-white rounded-lg shadow-xl border border-gray-200 p-4 w-64 mb-2">
            <p className="text-sm text-gray-600 mb-3 font-medium">Chat with us on:</p>
            <div className="space-y-2">
              ...
              {hasWhatsApp && (
                <a
                  ...
                  className="flex items-center space-x-3 p-3 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-lg transition-all"
              ...
              {hasTelegram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 p-3 bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-lg transition-all"
                  onClick={() => setIsOpen(false)}
                >
                  <svg className="h-6 w-6 shrink-0" viewBox="0 0 240 240" fill="white">
        ...
        <button
          onClick={toggleMenu}
          className="w-16 h-16 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-orange-300"
