        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-2 sm:space-x-3">
              ...
              <a href="mailto:contact@only4premioums.com" className="w-9 h-9 sm:w-10 sm:h-10 bg-linear-to-br from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-lg flex items-center justify-center hover:scale-105 transition-all" aria-label="Gmail">
                <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 24 24" fill="white">
